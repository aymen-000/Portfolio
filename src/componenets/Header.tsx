        ...
        <Navbar fluid rounded className='w-full p-5 bg-gray-800  dark:bg-[#1A1A1A] ' >
            ...
            <div className='flex justify-evenly max-md:hidden '>
                <div className='items-center flex justify-between space-x-8 max-md:hidden'  >
                    <a href="/#contact">
                    <button className="bg-transparent hover:bg-blue-500 text-white font-semibold hover:text-white py-2 px-3  border border-blue-500 hover:border-transparent rounded-lg text-2xl ">
                        Contact me
                    </button>
                    </a>
