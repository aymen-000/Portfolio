...
function Header() {
    ...
    return (
        <Navbar fluid rounded className='w-full p-5 bg-gray-800  dark:bg-[#1A1A1A] ' >
            ...
            <Navbar.Collapse>
                <Navbar.Link className=" cursor-pointer " as={"div"}><a href='#home' className='text-[#C1C1C1] no-underline'>Home</a></Navbar.Link>
                <Navbar.Link className=" cursor-pointer" as={"div"}><a href='#about' className='text-[#C1C1C1] no-underline'>About</a></Navbar.Link>
                <Navbar.Link className=" cursor-pointer " as={"div"}><a href='#projects' className='text-[#C1C1C1] no-underline'> Projects</a></Navbar.Link>
                <Navbar.Link className=" cursor-pointer " as={"div"}><a href="#services" className='text-[#C1C1C1] no-underline'>Services</a></Navbar.Link>
                <Navbar.Link className=" cursor-pointer " as={"div"}><a href='#resume' className='text-[#C1C1C1] no-underline' >Resume</a></Navbar.Link>
            ...
            <div className='flex justify-evenly max-md:hidden '>
                <div className='items-center flex justify-between space-x-8 max-md:hidden'  >
                    <a href="/#contact">
                    <button className="bg-transparent hover:bg-blue-500 text-white font-semibold hover:text-white py-1 px-3  border border-blue-500 hover:border-transparent rounded-lg">
                        Contact me
                    </button>
                    </a>
